...
Phase 6 تکمیل شده است: علاوه بر مدل داده، موتور محاسبات و احراز هویت وابسته به دوره، اکنون کارمند می‌تواند دوره ارزیابی را ایجاد و ویرایش کند، مدیر ناظر را انتخاب کند و پس از عبور از کنترل‌های آمادگی، برنامه دوره را منتشر و دوره را فعال کند. Manager در MVP همچنان فقط دسترسی خواندن دارد. مدیریت پروژه، توافق و مولفه کاری در Phase 7 انجام می‌شود.
