...
Phase 8 تکمیل شده است: علاوه بر Workflow دوره و برنامه توافق‌ها، کارمند اکنون می‌تواند هر تعداد اسپرینت با شماره ترتیب، بازه معتبر و وضعیت برنامه‌ریزی‌شده/فعال/بسته ایجاد و ویرایش کند. بازه‌ها داخل دوره کنترل می‌شوند و در هر دوره فقط یک اسپرینت فعال مجاز است. مدیریت تسک در Phase 9 انجام می‌شود.
